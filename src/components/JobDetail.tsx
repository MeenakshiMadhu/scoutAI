  ...
  return (
    <div className="detail-scroll h-full overflow-y-auto bg-[var(--card)]">
      ...
      <div className="px-6 py-5">
        ...
        <section className="mt-8 border-t border-gray-100 pt-6 flex flex-col items-center text-center">
          <button
            type="button"
            className="inline-flex items-center justify-center gap-2 rounded-lg border border-gray-200 px-8 py-2 min-w-[160px] text-sm font-medium text-gray-700 hover:border-gray-300 hover:bg-gray-50 transition-colors"
          >
            View job
            <svg
