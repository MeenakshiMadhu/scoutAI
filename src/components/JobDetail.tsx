    ...
    <div className="detail-scroll h-full overflow-y-auto bg-[var(--card)]">
      ...
      <div className="px-6 py-5">
        <section className="mb-6">
          <button
            type="button"
            className="w-full inline-flex items-center justify-center gap-2 rounded-lg border border-[var(--coral)] bg-[var(--coral)] px-4 py-2.5 text-sm font-medium text-white hover:bg-[#c94a3d] hover:border-[#c94a3d] transition-colors"
          >
            View job
            <svg
